...
public class susunkataActivity extends AppCompatActivity {
    ...
    private void openLevel(int index) {
        Intent intent;
        switch (index) {
            case 0: intent = new Intent(this, Level1SKActivity.class); break;
            case 1: intent = new Intent(this, Level2SKActivity.class); break;
            case 2: intent = new Intent(this, Level3SKActivity.class); break;
            case 3: intent = new Intent(this, Level4SKActivity.class); break;
            case 4: intent = new Intent(this, Level5SKActivity.class); break;
            default: return;
        }
