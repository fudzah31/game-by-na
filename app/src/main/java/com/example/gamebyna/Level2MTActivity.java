...
public class Level2MTActivity extends AppCompatActivity {
    private static final long TOTAL_TIME_MS = 30_000;
    private static final String PREFS_NAME = "app_settings";
    private static final String KEY_USER_ID = "current_user_id";

    // SharedPreferences for Matematika levels
    private static final String MT_PREFS       = "level_status_mt";
    ...
    private SharedPreferences mtPrefs;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_level2_mtactivity);
        ...
        mtPrefs = getSharedPreferences(MT_PREFS, Context.MODE_PRIVATE);
        ...
        View.OnClickListener optClick = v -> {
            ...
            v.setAlpha(0.6f);
            int id = v.getId();
            if (id == R.id.btn_option_1) selectedValue = 13;
            else if (id == R.id.btn_option_2) selectedValue = 14;
            else if (id == R.id.btn_option_3) selectedValue = 15;
        };
    ...
    private void showResultDialog(int stars) {
        ...
        next.setOnClickListener(v -> {
            dlg.dismiss();
            startActivity(new Intent(this, Level3MTActivity.class));
            finish();
        });
